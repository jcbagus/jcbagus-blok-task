...
const obj = document.getElementById("valuation-value");
animateValue(obj, 100, 364168, 5000);
...
$('.propertyTypeBox').click(function (){
	if(isMobile){
		currentPage = 2;
		$(".main1").addClass("hide").removeClass("show");
		$(".contentContainer, .section2").addClass("show").removeClass("hide");
		$(".mobile-navigation").addClass("open");
	}else{
		$(".section2").removeClass("transparent");
		$('html, body').animate({
...
$("#webNext").click(function (){
	if(!$(this).hasClass("disabled")){
		$("#webNext").addClass("disabled");
	$(".section3").removeClass("transparent");
	$('html, body').animate({
...
$('.next-btn-mobile').click(function (){
	if(isMobile){
		if(currentPage == 2){
			$(".contentContainer, .section3").addClass("show").removeClass("hide");
			$(".mobile-navigation").addClass("open")
			$(".section2").addClass("hide").removeClass("show");
			$(".skillBarValue").removeClass("value-20").addClass("value-40");
			currentPage = 3;
		}
	}
})
...
$('.back-btn-mobile').click(function (){
	if(isMobile){
		if(currentPage == 3){
			$(".section2").addClass("show").removeClass("hide");
			$(".section3").addClass("hide").removeClass("show");
			$(".skillBarValue").removeClass("value-40").addClass("value-20");
			currentPage = 2;
		}else if(currentPage == 2){
			$(".main1").addClass("show").removeClass("hide");
			$(".contentContainer, .section2").addClass("hide").removeClass("show");
...
if(isMobile){
	$(".section2, .section3, .webNextBtn").addClass("hide");
}else{
	$(".section2, .section3").addClass("transparent");
}

setTimeout(function(){
  $("#loadingScreen").fadeOut(500);
  $(".main-div, #contact, #footer").fadeIn(500);
}, 1500);